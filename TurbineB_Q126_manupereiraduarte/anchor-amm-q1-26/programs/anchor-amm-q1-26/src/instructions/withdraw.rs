...
impl<'info> Withdraw<'info> {
    pub fn withdraw(&mut self, amount: u64, min_x: u64, min_y: u64) -> Result<()> {
        ...
        // Verificar que al menos uno de los slippage inputs no sea cero
        require!(min_x != 0 || min_y != 0, AmmError::InvalidAmount);

        // Crear instancia de ConstantProduct con el estado actual del pool
        ...
        // Calcular y ejecutar el retiro de liquidez con protección de slippage
        let result = curve
